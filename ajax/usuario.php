...
switch($_GET["op"]) {
    ...
    case 'listar':
        ...
        while ($reg = $rspta->fetch_object()){
            $data[] = array(
                "0" => ($reg->condicion) ? '<button class="btn btn-warning" onclick="mostrar('.$reg->idusuario.')"><i class="fa fa-pencil"></i></button>'.' <button class="btn btn-danger" onclick="desactivar('.$reg->idusuario.')"><i class="fa fa-close"></i></button>' : 
    ...
    case 'permisos':
        //Obtenemos los permisos de la tabla permiso
    ...
    case 'verificar':
        ...
        if(isset($fetch))
        {
            ...
            //Determinar los accesos ddel usuario
