                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                            <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                ...
                                <select class="form-control selectpicker" id="idproveedor" name="idproveedor" data-live-search="true" required>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                ...
                                <input type="text" class="form-control" maxlength="7" id="serie_comprobante" name="serie_comprobante" placeholder="Serie">
                            </div>
                            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                <label for="num_comprobante">Número:</label>
                                <input type="text" class="form-control" maxlength="10" id="num_comprobante" name="num_comprobante" placeholder="Número" required>
                            </div>
                            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                <label for="impuesto">Impuesto:</label>
                                <input type="text" class="form-control" maxlength="10" id="impuesto" name="impuesto" placeholder="Impuesto" required>
                            </div>
